...
from erp.modules.module import get_module_root, MANIFEST_NAMES
from erp.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the ERP server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            erp.tools.config['init']['base'] = True
