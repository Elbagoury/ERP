...
from erp.tools.misc import ustr

from erp.addons.base.models.ir_mail_server import MailDeliveryException
from erp.addons.auth_signup.models.res_partner import SignupError, now
