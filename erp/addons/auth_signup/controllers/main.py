...
from erp import http, tools, _
from erp.addons.auth_signup.models.res_users import SignupError
from erp.addons.web.controllers.home import ensure_db, Home, SIGN_UP_REQUEST_PARAMS, LOGIN_SUCCESSFUL_PARAMS
from erp.addons.base_setup.controllers.main import BaseSetup
