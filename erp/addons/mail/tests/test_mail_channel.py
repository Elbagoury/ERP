...
from erp import Command, fields
from erp.addons.mail.models.mail_channel import channel_avatar, group_avatar
from erp.addons.mail.tests.common import mail_new_test_user
from erp.addons.mail.tests.common import MailCommon
from erp.exceptions import AccessError, UserError
from erp.tests import tagged, Form
from erp.tests.common import users
from erp.tools import html_escape, mute_logger
from erp.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestChannelAccessRights(MailCommon):
    ...
    @mute_logger('erp.addons.base.models.ir_rule', 'erp.addons.base.models.ir_model', 'erp.models')
    @users('user_public')
...
class TestChannelInternals(MailCommon):
    ...
    @users('employee')
    @mute_logger('erp.addons.mail.models.mail_mail', 'erp.models.unlink')
