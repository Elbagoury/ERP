...
from erp.addons.base.models.ir_mail_server import IrMailServer
from erp.addons.base.tests.common import MockSmtplibCase
from erp.addons.bus.models.bus import ImBus, json_dump
from erp.addons.mail.models.mail_mail import MailMail
from erp.addons.mail.models.mail_message import Message
from erp.addons.mail.models.mail_notification import MailNotification
from erp.tests import common, new_test_user
from erp.tools import formataddr, mute_logger, pycompat
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("erp.addons.base.models.ir_module", "erp.tools.translate"):
