...
from erp import api, release, SUPERUSER_ID
from erp.exceptions import UserError
from erp.models import AbstractModel
from erp.tools.translate import _
from erp.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to ERP's publisher warranty server to check the
