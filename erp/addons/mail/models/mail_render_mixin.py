...
from erp import _, api, fields, models, tools
from erp.addons.base.models.ir_qweb import QWebException
from erp.exceptions import UserError, AccessError
from erp.tools import is_html_empty, safe_eval
from erp.tools.rendering_tools import convert_inline_template_to_qweb, parse_inline_template, render_inline_template, template_env_globals
