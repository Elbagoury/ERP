# -*- coding: utf-8 -*-
from erp.addons.account.tests.common import AccountTestInvoicingCommon
from erp.tests import tagged
from erp.tests.common import Form, TransactionCase
from erp import fields, api, SUPERUSER_ID
...
class TestSequenceMixin(TestSequenceMixinCommon):
    ...
    def test_journal_sequence(self):
        ...
        with Form(copy2) as move_form:  # It is editable in the form
            with mute_logger('erp.tests.common.onchange'):
    ...
    def test_journal_sequence_ordering(self):
        ...
        with self.assertRaises(psycopg2.DatabaseError), mute_logger('erp.sql_db'), self.env.cr.savepoint():
