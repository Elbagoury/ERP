...
from erp.addons.account.tests.common import AccountTestInvoicingHttpCommon
from erp.tests.common import tagged
...
class TestPortalAttachment(AccountTestInvoicingHttpCommon):
    ...
    @mute_logger('erp.addons.http_routing.models.ir_http', 'erp.http')
