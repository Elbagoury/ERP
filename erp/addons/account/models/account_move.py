...
from erp import api, fields, models, _, Command
from erp.addons.base.models.decimal_precision import DecimalPrecision
from erp.addons.account.tools import format_rf_reference
from erp.exceptions import UserError, ValidationError, AccessError, RedirectWarning
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'ERP will automatically create one invoice line with default values to match it.',
    )
    ...
    def onchange(self, values, field_name, field_onchange):
        if field_name in ('line_ids', 'invoice_line_ids'):
            ...
            # File "/data/build/erp/addons/account/models/account_move.py", line 2127, in onchange
            # del values[to_del]
            # KeyError: 'line_ids'
    ...
    def _get_invoice_reference_erp_invoice(self):
        """ This computes the reference based on the ERP format.
    ...
    def _get_invoice_reference_erp_partner(self):
        """ This computes the reference based on the ERP format.
    ...
    def _disable_discount_precision(self):
        ...
        with patch('erp.addons.base.models.decimal_precision.DecimalPrecision.precision_get', new=precision_get):
            yield
