...
from erp import api, fields, models, Command, _
from erp.exceptions import ValidationError, UserError
from erp.tools import frozendict, formatLang, format_date, float_is_zero, Query
from erp.tools.sql import create_index
from erp.addons.web.controllers.utils import clean_action
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_reconciliation_single_partial(self, debit_vals, credit_vals):
        ...
        if debit_vals['currency'] == credit_vals['currency'] == company_currency \
            ...
            debit_rate = get_erp_rate(debit_vals)
            ...
            credit_rate = get_erp_rate(credit_vals)
