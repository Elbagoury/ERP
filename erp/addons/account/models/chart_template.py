...
from erp import api, fields, models, Command, _, osv
from erp import SUPERUSER_ID
from erp.exceptions import UserError, ValidationError
from erp.http import request
from erp.addons.account.models.account_tax import TYPE_TAX_USE
from erp.addons.account.models.account_account import ACCOUNT_CODE_REGEX
from erp.tools import html_escape
...
def update_taxes_from_templates(cr, chart_template_xmlid):
    ...
    def _notify_accountant_managers(taxes_to_check):
        ...
        erpbot = env.ref('base.partner_root')
        message_body = _(
