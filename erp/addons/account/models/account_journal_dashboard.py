...
from erp import models, api, _, fields
from erp.exceptions import UserError
from erp.osv import expression
from erp.release import version
from erp.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from erp.tools.misc import formatLang, format_date as erp_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': erp_format_date(self.env, activity.get('date_deadline'))
                }
