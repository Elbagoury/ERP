# -*- coding: utf-8 -*-
from erp import api, Command, fields, models, _
from erp.osv import expression
from erp.exceptions import UserError, ValidationError
from erp.addons.base.models.res_bank import sanitize_account_number
from erp.tools import remove_accents
import logging
import re
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('erp', 'ERP'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the ERP reference.")
