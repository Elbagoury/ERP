...
import erp
from erp import api, http, models
from erp.http import request
from erp.tools import file_open, image_process, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = erp.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.erp.com/buy",
            "name": user.name,
            "username": user.login,
