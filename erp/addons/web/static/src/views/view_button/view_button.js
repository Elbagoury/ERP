...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(erp.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in erpToBootstrapClasses) {
                    cls = erpToBootstrapClasses[cls];
                }
                classNames.push(cls);
