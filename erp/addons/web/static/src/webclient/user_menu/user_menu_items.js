...
import { Component, markup } from "@erp/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.erp.com/documentation/16.0";
    return {
        type: "item",
        id: "documentation",
...
function erpAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: env._t("My ERP.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.location.href = "https://accounts.erp.com/account";
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("erp_account", erpAccountItem)
