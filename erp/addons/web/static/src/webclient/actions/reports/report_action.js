...
import { Component, useRef, useSubEnv } from "@erp/owl";
 ...
 * It uses a feature to automatically create links to other erp pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
