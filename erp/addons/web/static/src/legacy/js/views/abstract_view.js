/** @erp-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. ERP JS views are the
 ...
 * the word 'view' has historical significance in ERP code, so we replaced the
