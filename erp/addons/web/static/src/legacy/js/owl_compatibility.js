erp.define('web.OwlCompatibility', function (require) {
    "use strict";
    ...
    /**
     * This file defines the necessary tools for the transition phase where ERP
    ...
    const widgetSymbol = erp.widgetSymbol;
     ...
     * adapter for Owl components that embed ERP legacy widgets (or dynamically
     * both Owl components and ERP legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends LegacyComponent {
        ...
        /**
         * Mocks _trigger_up to redirect ERP legacy events to OWL events.
         *
         * @private
         * @param {ERPEvent} ev
         */
     ...
     * together when an ERP legacy widget needs to instantiate Owl components.
    ...
    class ProxyComponent extends LegacyComponent {
         ...
         * ERP legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
