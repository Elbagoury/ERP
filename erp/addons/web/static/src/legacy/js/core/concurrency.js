erp.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in ERP.
 *
 * The basic concurrency primitives in ERP JS are the callback, and the
...
return {
    ...
    /**
     * A (ERP) mutex is a primitive for serializing computations.  This is
