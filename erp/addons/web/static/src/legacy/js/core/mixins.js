erp.define('web.mixins', function (require) {
"use strict";
...
function ERPEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
ERPEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

ERPEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new ERPEvent(this, name, info);
