erp.define('web.relational_fields', function (require) {
"use strict";
...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {ERPEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {ERPEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {ERPEvent|MouseEvent} ev this event comes either from the 'Add
