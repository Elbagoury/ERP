...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("ERPBeforeTestHook", "ERPAfterTestHook"); // ERP customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("ERPBeforeTestHook"); // ERP customization
  	...
  	finish: function finish() {
        ...
        emit("ERPAfterTestHook", this); // ERP customization
