erp.define('web.list_tests', function (require) {
"use strict";
...
const { _t } = core;
const { markup, onMounted, onWillUnmount, xml } = require("@erp/owl");
...
QUnit.module('LegacyViews', {
        ...
        var list = await createView({
            ...
            mockRPC: function (route, args) {
                return this._super.apply(this, arguments).then(result => {
                    ...
                    // (see 5691b126f06/erp/models.py#L2521-L2528)
    ...
    QUnit.test('display a tooltip on a field', async function (assert) {
        ...
        var initialDebugMode = erp.debug;
        erp.debug = false;
