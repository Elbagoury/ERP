...
This module provides the core of the ERP Web Client.
""",
    'depends': ['base'],
    'auto_install': True,
    'data': [
    ...
    'assets': {
        ...
        'web.assets_common': [
            ...
            'web/static/src/legacy/scss/web.zoomerp.scss',
            ...
            'web/static/lib/owl/erp_module.js',
            ...
            'web/static/src/legacy/js/libs/zoomerp.js',
