...
from erp.tools import topological_sort
from erp.addons.base.models.assetsbundle import AssetsBundle, WebAsset


_logger = logging.getLogger(__name__)

class TestStaticInheritanceCommon(erp.tests.TransactionCase):
    def setUp(self):
        super().setUp()
