...
from erp.tests.common import HttpCase
from erp.modules.module import get_manifest
...
class TestAssetsGenerateTimeCommon(erp.tests.TransactionCase):
    ...
    def generate_bundles(self):
        ...
        for bundle in bundles:
            with mute_logger('erp.addons.base.models.assetsbundle'):
...
@erp.tests.tagged('post_install', '-at_install', 'assets_bundle')
...
@erp.tests.tagged('post_install', '-at_install', '-standard', 'assets_bundle')
...
class TestLoad(HttpCase):
    def test_assets_already_exists(self):
        ...
        _save_attachment = erp.addons.base.models.assetsbundle.AssetsBundle.save_attachment
        ...
        with patch('erp.addons.base.models.assetsbundle.AssetsBundle.save_attachment', save_attachment):
