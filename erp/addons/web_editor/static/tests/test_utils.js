erp.define('web_editor.test_utils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.test_utils');
var ERPEditorLib = require('@web_editor/js/editor/erp-editor/src/ERPEditor');
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (ERPEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = ERPEditorLib.childNodeIndex(point.node) + 1;
