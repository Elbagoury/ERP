/** @erp-module alias=web_editor.convertInline */
'use strict';

import { isBlock, rgbToHex } from '../editor/erp-editor/src/utils/utils';
...
async function toInline($editable, cssRules, $iframe) {
    $editable.removeClass('erp-editor-editable');
    const editable = $editable.get(0);
    ...
    $editable.addClass('erp-editor-editable');
}
/**
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const fonts = erp.__DEBUG__.services["wysiwyg.fonts"];
