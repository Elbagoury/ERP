erp.define('wysiwyg.widgets.LinkTools', function (require) {
'use strict';
...
const LinkTools = Link.extend({
    ...
    _updateColorpicker: async function (cssProperty) {
        ...
        if (!colorpicker) {
            colorpicker = new ColorPaletteWidget(this, {
                ...
                $editable: $(this.options.wysiwyg.erpEditor.editable),
            ...
            colorpicker.on('custom_color_picked color_picked color_hover color_leave', this, (ev) => {
                ...
                if (['custom_color_picked', 'color_picked'].includes(ev.name)) {
                    ...
                    this.options.wysiwyg.erpEditor.execCommand('applyColor', '', 'color');
                    this.options.wysiwyg.erpEditor.execCommand('applyColor', '', 'backgroundColor');
                }
     ...
     */
    _addHintClasses () {
        this.options.wysiwyg.erpEditor.observerUnactive("hint_classes");
        this.$link.addClass('oe_edited_link');
        this.$button.addClass('active');
        this.options.wysiwyg.erpEditor.observerActive("hint_classes");
    },
    /**
    ...
    _removeHintClasses () {
        this.options.wysiwyg.erpEditor.observerUnactive("hint_classes");
        $(this.options.wysiwyg.erpEditor.document).find('.oe_edited_link').removeClass('oe_edited_link');
    ...
    __onURLInput() {
        this._super(...arguments);
        this.options.wysiwyg.erpEditor.historyPauseSteps('_onURLInput');
        this._adaptPreview();
        this.options.wysiwyg.erpEditor.historyUnpauseSteps('_onURLInput');
    },
});
