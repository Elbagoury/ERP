erp.define('web_editor.snippets.options', function (require) {
'use strict';
...
const SnippetOptionWidget = Widget.extend({
    ...
    _select: async function (previewMode, widget) {
        ...
        if (previewMode === true) {
            this.options.wysiwyg.erpEditor.automaticStepUnactive('preview_option');
        }
        ...
        if (previewMode === 'reset' || previewMode === false) {
            this.options.wysiwyg.erpEditor.automaticStepActive('preview_option');
        }
...
registry.sizing = SnippetOptionWidget.extend({
    ...
    start: function () {
        ...
        this.$handles.on('mousedown', function (ev) {
            ev.preventDefault();
            self.options.wysiwyg.erpEditor.automaticStepUnactive('resizing');
            ...
            if (rowEl.classList.contains('o_grid_mode')) {
                self.options.wysiwyg.erpEditor.observerUnactive('displayBackgroundGrid');
                backgroundGridEl = gridUtils._addBackgroundGrid(rowEl, 0);
                self.options.wysiwyg.erpEditor.observerActive('displayBackgroundGrid');
            ...
            const bodyMouseUp = function () {
                ...
                self.options.wysiwyg.erpEditor.automaticStepActive('resizing');
            };
...
￼    */
    ...
    _computeMaxDisplayWidth() {
        ...
        // width since we only use col-lg-* in ERP).
...
registry.ColoredLevelBackground = registry.BackgroundToggler.extend({
    ...
    _markColorLevel: function () {
        this.options.wysiwyg.erpEditor.observerUnactive('_markColorLevel');
        this.$target.addClass('o_colored_level');
        this.options.wysiwyg.erpEditor.observerActive('_markColorLevel');
    },
});
