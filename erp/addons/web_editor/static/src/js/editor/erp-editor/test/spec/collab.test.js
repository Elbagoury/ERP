import { ERPEditor } from '../../src/ERPEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        ERPEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new ERPEditor(clientInfo.editable, {
            toSanitize: false,
    ...
    ERPEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
