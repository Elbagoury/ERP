...
export class ERPEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.editable.classList.add("erp-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const erpHtml = dataHtmlElement.innerHTML;
        const erpText = selection.toString();
        clipboardEvent.clipboardData.setData('text/plain', erpText);
        clipboardEvent.clipboardData.setData('text/html', erpHtml);
        clipboardEvent.clipboardData.setData('text/erp-editor', erpHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('erp-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const erpEditorHtml = ev.clipboardData.getData('text/erp-editor');
        ...
        if (erpEditorHtml && targetSupportsHtmlContent) {
            const fragment = parseHTML(erpEditorHtml);
