...
Also, adds methods to convert values back to ERP models.
"""
...
from erp import _, api, models, fields
from erp.exceptions import UserError, ValidationError
from erp.tools import ustr, posix_to_ldml, pycompat
from erp.tools import html_escape as escape
from erp.tools.misc import get_lang, babel_locale_parse
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = erp.modules.get_module_resource(
