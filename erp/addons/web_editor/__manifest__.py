...
""",
    ...
    'assets': {
        ...
        'web_editor.assets_wysiwyg': [
            ...
            # erp-editor
            'web_editor/static/src/js/editor/erp-editor/src/ERPEditor.js',
            'web_editor/static/src/js/editor/erp-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/erp-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/erp-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/erp-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/erp-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/erp-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/erp-editor/src/commands/toggleList.js',
            ...
            'web_editor/static/src/js/editor/erp-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/erp-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/erp-editor/src/checklist.scss',
        ],
        'web.assets_common': [
            'web_editor/static/src/js/editor/erp-editor/src/base_style.scss',
            'web_editor/static/lib/vkbeautify/**/*',
            'web_editor/static/src/js/common/**/*',
            'web_editor/static/src/js/editor/erp-editor/src/utils/utils.js',
        ...
        "web.dark_mode_assets_backend": [
            'web_editor/static/src/scss/erp-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/erp-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/erp-editor/tableui.dark.scss',
