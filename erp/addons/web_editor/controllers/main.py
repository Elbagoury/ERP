...
from erp import http, tools, _, SUPERUSER_ID
from erp.addons.http_routing.models.ir_http import slug, unslug
from erp.addons.web_editor.tools import get_video_url_data
from erp.exceptions import UserError, MissingError
from erp.modules.module import get_resource_path
from erp.tools import file_open
from erp.tools.mimetypes import guess_mimetype
from erp.tools.image import image_data_uri, binary_to_image
...
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.erp.com'
