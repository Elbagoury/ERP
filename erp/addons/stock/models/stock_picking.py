...
from erp import SUPERUSER_ID, _, api, fields, models
from erp.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from erp.exceptions import UserError, ValidationError
from erp.osv import expression
from erp.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime, format_date, groupby
from erp.tools.float_utils import float_compare, float_is_zero, float_round
...
class PickingType(models.Model):
    ...
    auto_show_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, ERP will automatically show the reception report (if there are moves to allocate to) when validating.")
