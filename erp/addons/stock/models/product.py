...
from erp.tools import float_is_zero, check_barcode_encoding
from erp.tools.float_utils import float_round
from erp.tools.mail import html2plaintext, is_html_empty
