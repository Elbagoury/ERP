...
from erp.addons.stock.models.stock_rule import ProcurementException
from erp.exceptions import RedirectWarning, UserError, ValidationError
from erp.osv import expression
from erp.tools import float_compare, frozendict, split_every
...
class StockWarehouseOrderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity specified for this field, ERP generates "
             "a procurement to bring the forecasted quantity to the Max Quantity.")
    product_max_qty = fields.Float(
        'Max Quantity', digits='Product Unit of Measure', required=True, default=0.0,
        help="When the virtual stock goes below the Min Quantity, ERP generates "
