...
from erp import SUPERUSER_ID, _, api, fields, models, registry
from erp.exceptions import UserError
from erp.osv import expression
from erp.tools import float_compare, float_is_zero, html_escape
from erp.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~erp.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~erp.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
