...
from erp import _, api, Command, fields, models
...
from erp.tools.misc import clean_context, OrderedSet, groupby
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            if last_message and last_message.subject == msg_subject:
                continue
            erpbot_id = self.env['ir.model.data']._xmlid_to_res_id("base.partner_root")
            doc.message_post(body=msg, author_id=erpbot_id, subject=msg_subject)
