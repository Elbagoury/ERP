...
from erp import api, fields, models, Command
from erp import SUPERUSER_ID, _
from erp.exceptions import ValidationError, UserError
from erp.tools import mute_logger

_logger = logging.getLogger('erp.addons.base.partner.merge')
    ...
    def _update_foreign_keys(self, src_partners, dst_partner):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('erp.sql_db'), self._cr.savepoint():
