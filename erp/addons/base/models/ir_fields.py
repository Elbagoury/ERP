...
from erp.tools import ustr, OrderedSet
from erp.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an erp
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`erp.osv.orm.Model.write` expects.

        :param model: :class:`erp.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`erp.fields.Field`
