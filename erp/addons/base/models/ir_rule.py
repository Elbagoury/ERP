...
from erp import api, fields, models, tools, SUPERUSER_ID, _
from erp.exceptions import AccessError, ValidationError
from erp.osv import expression
from erp.tools import config
from erp.tools.safe_eval import safe_eval, time
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - erp/addons/test_access_rights/tests/test_feedback.py
        # - erp/addons/test_access_rights/tests/test_ir_rules.py
        # - erp/addons/base/tests/test_orm.py (/home/dle/src/erp/master-nochange-fp/erp/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.clear_caches()
        return res
