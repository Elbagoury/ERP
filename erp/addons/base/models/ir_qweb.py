...
QWeb is the primary templating engine used by ERP. It is an XML templating
...
<https://www.erp.com/documentation/16.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed erp user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` ERP method.
...
from erp import api, models, tools
from erp.tools import config, safe_eval, pycompat, SUPPORTED_DEBUGGER
from erp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from erp.tools.json import scriptsafe
from erp.tools.misc import str2bool
from erp.tools.image import image_data_uri
from erp.http import request
from erp.modules.module import get_resource_path, get_module_path
from erp.tools.profiler import QwebTracker
from erp.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from erp.addons.base.models.assetsbundle import AssetsBundle
from erp.addons.base.models.ir_asset import can_aggregate, STYLE_EXTENSIONS, SCRIPT_EXTENSIONS, TEMPLATE_EXTENSIONS
