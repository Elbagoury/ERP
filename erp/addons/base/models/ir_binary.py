...
from erp.exceptions import MissingError, UserError
from erp.http import Stream, request
from erp.tools import file_open, replace_exceptions
from erp.tools.image import image_process, image_guess_size_from_field_name
from erp.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:erp.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~erp.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`erp.tools.image.image_process`.
