...
import erp
from erp import api, http, models, tools, SUPERUSER_ID
from erp.exceptions import AccessDenied, AccessError, MissingError
from erp.http import request, Response, ROUTING_KEYS, Stream
from erp.modules.registry import Registry
from erp.service import security
from erp.tools import consteq, submap
from erp.tools.translate import code_translations
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = registry._init_modules.union(erp.conf.server_wide_modules)
            if tools.config['test_enable'] and erp.modules.module.current_test:
                installed.add(erp.modules.module.current_test)
