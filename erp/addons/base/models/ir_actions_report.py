...
from erp.exceptions import UserError, AccessError
from erp.tools.safe_eval import safe_eval, time
from erp.tools.misc import find_in_path
from erp.tools import check_barcode_encoding, config, is_html_empty, parse_version
from erp.http import request
from erp.osv.expression import NEGATIVE_TERM_OPERATORS, FALSE_DOMAIN
    ...
    def _merge_pdfs(self, streams):
        ...
        for stream in streams:
            try:
                ...
                raise UserError(_("ERP is unable to merge the generated PDFs."))
