...
from erp.tests import common
from erp.tools import mute_logger, view_validation
from erp.addons.base.models.ir_ui_view import (
...
class ViewCase(common.TransactionCase):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False):
        with mute_logger('erp.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('erp.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('erp.addons.base.models.ir_ui_view')
