...
from erp import SUPERUSER_ID, Command
from erp.exceptions import RedirectWarning, UserError, ValidationError
from erp.tests.common import TransactionCase, BaseCase
from erp.tools import mute_logger
from erp.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('erp.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import erp", mode="exec")
