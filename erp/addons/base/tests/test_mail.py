...
from erp.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from erp.tests.common import BaseCase, TransactionCase
...
class EmailConfigCase(TransactionCase):
    @patch.dict("erp.tools.config.options", {"email_from": "settings@example.com"})
