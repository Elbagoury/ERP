...
import erp
from erp.exceptions import UserError, ValidationError, AccessError
from erp.tools import mute_logger
from erp.tests import common
from erp import Command
...
class TestServerActions(TestServerActionsBase):
    ...
    @mute_logger('erp.addons.base.models.ir_model', 'erp.models')
    ...
    def test_80_permission(self):
        ...
        with self.assertRaises(AccessError), mute_logger('erp.addons.base.models.ir_actions'):
            self_demo.with_context(self.context).run()
