...
from erp.addons.base.tests.common import SavepointCaseWithUserDemo
from erp.fields import Date
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('erp.osv.expression'):
    ...
    def test_accent(self):
        ...
        with patch('erp.osv.expression.get_unaccent_wrapper') as w:
