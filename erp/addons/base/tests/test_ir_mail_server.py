...
from erp import tools
from erp.addons.base.tests import test_mail_examples
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        # remove the notifications email to simulate a mis-configured ERP database
        ...
        with mute_logger('erp.addons.base.models.ir_mail_server'):
    ...
    @mute_logger('erp.models.unlink')
    @patch.dict("erp.tools.config.options", {"from_filter": "test.com", "smtp_server": "example.com"})
    def test_mail_server_binary_arguments_domain(self):
        """Test the configuration provided in the erp-bin arguments.
        ...
        # Remove all mail server so we will use the erp-bin arguments
    ...
    def test_mail_server_mail_default_from_filter(self):
        """Test that the config parameter "mail.default.from_filter" overwrite the erp-bin
