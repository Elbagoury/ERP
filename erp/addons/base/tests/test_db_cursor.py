...
def registry():
    return erp.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = erp.api.Environment(self.cr, erp.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('erp.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:erp.sql_db:Found different un-closed cursor', msg)
