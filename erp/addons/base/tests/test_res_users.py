...
from erp.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from erp.exceptions import UserError
from erp.tests.common import TransactionCase, Form, tagged, new_test_user
...
class TestUsers(TransactionCase):
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('erp.addons.base.models.res_users.request', request)
