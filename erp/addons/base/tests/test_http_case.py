...
from erp.tests.common import HttpCase, tagged
from erp.tools import mute_logger, logging
    ...
    def test_console_error_string(self):
        with self.assertLogs(level='ERROR') as log_catcher:
            with self.assertRaises(AssertionError) as error_catcher:
                ...
                with patch('erp.tests.common.ChromeBrowser.take_screenshot', return_value=None):
