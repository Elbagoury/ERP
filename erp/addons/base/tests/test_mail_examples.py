...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.erp.com">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as ERP and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this ERP mailinglist, but when you start implying that Postgres
