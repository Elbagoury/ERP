...
"""The ERP API module defines ERP Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~erp.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~erp.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/erp/erp/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def envs(cls):
        raise NotImplementedError(
            "Since ERP 15.0, Environment.envs no longer works; "
    ...
    def manage(cls):
        warnings.warn(
            "Since ERP 15.0, Environment.manage() is useless.",
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~erp.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~erp.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~erp.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~erp.addons.base.models.res_company.Company>`
    ...
    def clear_upon_failure(self):
        ...
        """
        warnings.warn(
            "Since ERP 15.0, use cr.savepoint() instead of env.clear_upon_failure().",
            DeprecationWarning, stacklevel=2,
        )
